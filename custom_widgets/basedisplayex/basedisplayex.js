function basedisplayex(widget_id, url, skin, parameters)
{
    ...
    {
        if (state.state == self.parameters.state_active || ("active_map" in self.parameters && self.parameters.active_map.includes(state)))
        {
